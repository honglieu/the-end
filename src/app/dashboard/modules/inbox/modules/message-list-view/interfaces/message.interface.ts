import { EMessageProperty, SocketType } from '@shared/enum';
...
export interface IExportConversationFilePayload {
  conversations: IListMessageResolve[];
  mailBoxId: string;
  type?: string;
}

export interface IDownloadPDFFile {
  companyId?: string;
  type?: SocketType;
  conversations?: {
    conversationId: string;
