...
@Component({
  selector: 'facebook-filter',
  templateUrl: './facebook-filter.component.html',
  styleUrl: './facebook-filter.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class FacebookFilterComponent implements OnInit, OnDestroy {
  ...
  subscribeStatisticsVoiceMailMessage() {
    this.inboxSidebarService.statisticsFacebookMessageBS$
