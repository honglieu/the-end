...
@Component({
  selector: 'facebook-view-detail-header',
  templateUrl: './facebook-view-detail-header.component.html',
  styleUrls: ['./facebook-view-detail-header.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class FacebookViewDetailHeaderComponent implements AfterViewInit {
  ...
  handleMenu(
    ...
    this.facebookMenuService
      ...
      .then((value) => {
        ...
        this.updateCurrentFacebook(field, value, task, option);
