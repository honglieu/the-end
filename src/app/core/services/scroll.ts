...
export interface TrudiScrollToOptions {
...
export class TrudiScrollService {
  private doc: Document;

  constructor(private ngZone: NgZone, @Inject(DOCUMENT) doc: TrudiSafeAny) {
    this.doc = doc;
  }
  ...
  isWindow(obj: TrudiSafeAny): boolean {
  ...
  scrollTo(
    ...
    const frameFunc = (): void => {
      ...
      if (this.isWindow(target)) {
        ...
        target.constructor.name === 'HTMLDocument'
      ) {
