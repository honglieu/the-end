...
export const syncs = 'https://api.attic.trulet.com/syncs/';
export const email = 'https://api.attic.trulet.com/email/';
...
export const configGoogleApplication = {
  ...
  REDIRECT_URI: 'https://portal.attic.trulet.com',
  SCOPE:
...
export const configOutlookApplication = {
  ...
  REDIRECT_URI: 'https://portal.attic.trulet.com/outlook-callback',
  SCOPE:
