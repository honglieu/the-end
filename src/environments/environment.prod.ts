...
export const apiKey = 'https://api.prod.trulet.com';
export const auth = 'https://api.prod.trulet.com/auth/';
export const users = 'https://api.prod.trulet.com/users/';
export const properties = 'https://api.prod.trulet.com/properties/';
export const conversations = 'https://api.prod.trulet.com/conversations/';
export const agencies = 'https://api.prod.trulet.com/agencies/';
export const syncs = 'https://api.prod.trulet.com/syncs/';
export const email = 'https://api.prod.trulet.com/email/';
export const aiApiEndpoint = 'https://ai.prod.trudi.ai';
export const aiWebSocketUrl = 'wss://ai.prod.trudi.ai/communication/ws';
export const webSocketUrl = 'wss://message.prod.trulet.com';
export const voxeet = 'https://webapp.trulet.com';
export const env: string = 'live';
export const gaTrackingId = 'GTM-KD7M3CZT';
...
export const urlDownloadEnv = 'cdn.prod.trulet.com';
...
export const configGoogleApplication = {
  ...
  REDIRECT_URI: 'https://portal.trudi.ai',
  SCOPE:
...
export const configOutlookApplication = {
  ...
  REDIRECT_URI: 'https://portal.trudi.ai/outlook-callback',
  SCOPE:
