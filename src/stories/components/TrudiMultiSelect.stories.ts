...
import { TrudiMultiSelectComponent } from 'src/app/trudi-ui/select/trudi-multi-select/trudi-multi-select.component';
...
export default {
  title: 'trudi-ui/Select/TrudiMultiSelect',
  component: TrudiMultiSelectComponent,
  argTypes: {
    scrollToEnd: {
      action: 'scrollToEnd',
